...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-128 w3-content w3-text-grey">
        <div class="w3-container">
            <table class="w3-table-all w3-centered">
                ...
                <tbody>
                    <?php
                        //Cria nova instância da classe AdministradorController
                        $adm = new AdministradorController();
                        //Acessa o método gerarLista do objeto e armazena os resultados
                        $results = $adm->gerarLista();
                        //Se o resultado não é nulo (houve retorno de informação)
                        if($results != null) {
    ...
    <!-- Fim Tabela de Administradores Cadastrados -->
